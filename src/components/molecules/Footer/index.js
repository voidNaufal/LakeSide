...
import logoMSN from "../../../assets/images/logolakeside.png";
    ...
    <div>
      ...
      >
        ...
        <div className="flex items-center mt-4">
          ...
          <a
            href="https://instagram.com/kopi.lakeside?igshid=NzZlODBkYWE4Ng=="
            target="blank"
            className="text-2xl text-accent hover:text-fuchsia-500 hover:-translate-y-1.5 shadow-lg mx-1 duration-300"
          >
      ...
      <footer className="px-10 py-6 text-sm text-center text-base-100 border-base-300 bg-neutral ">
        ...
        <div className="flex flex-col items-center justify-center mt-6 md:flex-row text-accent">
          <p>&copy; Copyright 2023, Kopi LakeSide. All Rights Reserved</p>
        </div>
      </footer>
      <ButtonWa />
    </div>
